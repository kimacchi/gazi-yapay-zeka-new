    ...
    <WavyBackground>
      <div className="w-full flex flex-col items-center sm:py-24 text-center sm:gap-12 py-12 gap-12 px-8 sm:px-0">
        ...
        <CardContainer className="inter-var">
          <CardBody className=" relative group/card  hover:shadow-2xl hover:shadow-emerald-500/[0.1] bg-black/70  border-white/[0.2]  w-auto sm:w-[50rem] h-auto rounded-xl p-6 border  ">
            ...
            >
              <button className="flex items-center justify-center w-full px-2 py-4 bg-[#e05b0d] backdrop-blur-sm rounded-md text-lg font-mono hover:bg-dark-orange">
                <CalendarClockIcon className="w-12 h-12" />
              </button>
              <button className=" w-full px-2 py-4 bg-[#e05b0d] backdrop-blur-sm rounded-md text-lg font-mono hover:bg-dark-orange">
                Bloglarımız
              </button>
              <button className=" w-full px-2 py-4 bg-[#e05b0d] backdrop-blur-sm rounded-md text-lg font-mono hover:bg-dark-orange">
                İdari Üyelerimiz
